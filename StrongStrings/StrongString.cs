...
namespace ktsu.io.StrongStrings
{
	...
	public abstract record class StrongString : IStrongString
	{
		...
		public abstract TDest SanitizeInput<TDest>() where TDest : IStrongString;
	...
	public abstract record class StrongString<TDerived> : StrongString where TDerived : StrongString<TDerived>
	{
