...
namespace ktsu.io.StrongStrings
{
	...
	public abstract record class AnyStrongString<TDerived>
		: AnyStrongString
		where TDerived : AnyStrongString<TDerived>
	{
		public static explicit operator AnyStrongString<TDerived>(char[]? value)
		{
			return FromCharArray<TDerived>(value);
		}

		public static explicit operator AnyStrongString<TDerived>(string? value)
		{
			return FromString<TDerived>(value);
		}

		public static TDerived FromCharArray(char[]? value)
		{
			return FromCharArray<TDerived>(value);
		}

		public static TDerived FromString(string value)
		{
			return FromString<TDerived>(value);
		}
	...
	public abstract record class AnyStrongString<TDerived, TValidator>
		: AnyStrongString<TDerived>
		where TDerived : AnyStrongString<TDerived, TValidator>
		where TValidator : IValidator
	{
		public override bool IsValid() => Validate<TValidator, NoValidator, NoValidator, NoValidator, NoValidator>(this);
	}

	public abstract record class AnyStrongString<TDerived, TValidator1, TValidator2>
		: AnyStrongString<TDerived>
		where TDerived : AnyStrongString<TDerived, TValidator1, TValidator2>
		where TValidator1 : IValidator
		where TValidator2 : IValidator
	{
		public override bool IsValid() => Validate<TValidator1, TValidator2, NoValidator, NoValidator, NoValidator>(this);
	}

	public abstract record class AnyStrongString<TDerived, TValidator1, TValidator2, TValidator3>
		: AnyStrongString<TDerived>
		where TDerived : AnyStrongString<TDerived, TValidator1, TValidator2, TValidator3>
		where TValidator1 : IValidator
		where TValidator2 : IValidator
		where TValidator3 : IValidator
	{
		public override bool IsValid() => Validate<TValidator1, TValidator2, TValidator3, NoValidator, NoValidator>(this);
	}

	public abstract record class AnyStrongString<TDerived, TValidator1, TValidator2, TValidator3, TValidator4>
		: AnyStrongString<TDerived>
		where TDerived : AnyStrongString<TDerived, TValidator1, TValidator2, TValidator3, TValidator4>
		where TValidator1 : IValidator
		where TValidator2 : IValidator
		where TValidator3 : IValidator
		where TValidator4 : IValidator
	{
		public override bool IsValid() => Validate<TValidator1, TValidator2, TValidator3, TValidator4, NoValidator>(this);
	}

	public abstract record class AnyStrongString<TDerived, TValidator1, TValidator2, TValidator3, TValidator4, TValidator5>
		: AnyStrongString<TDerived>
		where TDerived : AnyStrongString<TDerived, TValidator1, TValidator2, TValidator3, TValidator4, TValidator5>
		where TValidator1 : IValidator
		where TValidator2 : IValidator
		where TValidator3 : IValidator
		where TValidator4 : IValidator
		where TValidator5 : IValidator
	{
		public override bool IsValid() => Validate<TValidator1, TValidator2, TValidator3, TValidator4, TValidator5>(this);
	}
}
