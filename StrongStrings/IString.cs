...
{
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "It's a string, which is absolutely a collection of chars, but I'm not gonna call it that")]
	public interface IString : IComparable, IEnumerable, IComparable<IString>, IEnumerable<char>
	{
